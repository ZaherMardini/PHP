...
<head>
    ...
    <link rel="stylesheet" href="./Assets/CSS/all.min.css"><!--Font Awoesome-->
</head>
<body>
<div class="container">
        ...
        <form action="process.php" method="post">
            ...
            <textarea required name="inputText" id="inputText" rows="4" cols="50">zaher is here</textarea>
            ...
            <input name="process" type="submit" value="Transform">
        </form>
    </div>
